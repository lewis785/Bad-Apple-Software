  	...
  	<header id="header-1" class="soft-scroll header-1">
  		...
  		<div class="middle-bit">
  			...
  			<form role="form" id="register-form" class="register-form text-center lead" name="login" method="post" action="../php/Wizard/insertLogin.php">
  				...
  				<div class="form-group">
  					<input type="checkbox" value="remember-me" name="checkCookie" required="required">
  					<label>
  						<u class="littlestuff">This website use Cookies by ticking you are agreeing to their use</i></u>
  					</label>
