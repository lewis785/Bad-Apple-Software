...
--
-- Host: localhost
-- Generation Time: Jan 23, 2016 at 07:18 PM
...
CREATE TABLE IF NOT EXISTS `courses` (
  `CourseID` int(8) NOT NULL AUTO_INCREMENT COMMENT 'Unique Identifier for each course',
  `CourseName` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Name of Course',
  `QualificationID` int(8) NOT NULL COMMENT 'Qualification associated with course',
  PRIMARY KEY (`CourseID`),
  UNIQUE KEY `QualificationID` (`QualificationID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Contains courses and associated qualification' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `qualifications` (
  ...
  `Qualification` tinytext COLLATE utf8_unicode_ci NOT NULL COMMENT 'The qualification itself',
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_ibfk_1` FOREIGN KEY (`QualificationID`) REFERENCES `qualifications` (`QualificationID`);
