...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2016 at 01:32 AM
...
--
-- Table structure for table `ucastariffs`
--

CREATE TABLE IF NOT EXISTS `ucastariffs` (
  `TariffID` int(100) NOT NULL AUTO_INCREMENT,
  `PUBUKPRN` int(100) NOT NULL,
  `KisCourseId` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `UCASTariff` int(100) NOT NULL,
...
--
-- Table structure for table `unistatscourses`
--

CREATE TABLE IF NOT EXISTS `unistatscourses` (
  `CourseID` int(100) NOT NULL AUTO_INCREMENT,
  `KisCourseId` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `PUBUKPRN` int(100) NOT NULL,
  `Title` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `ApiUrl` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `KisMode` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `UCASTariff` int(100) NOT NULL,
  PRIMARY KEY (`CourseID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `unistatsinstitutes`
--

CREATE TABLE IF NOT EXISTS `unistatsinstitutes` (
  `InstituteID` int(100) NOT NULL AUTO_INCREMENT,
  `PUBUKPRN` int(100) NOT NULL,
  `Name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `SortableName` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 1, 2, 1995, 7, 2000, 'Example Ltd.', 'Manager', 'Manager at Example Ltd.'),
(3, 1, 6, 2006, 10, 2010, 'Example co.', 'Janitor', 'Janitor at Example co.');
...
INSERT INTO `userlogin` (`UserID`, `EmailAddress`, `UserName`, `Password`, `DateJoined`, `AccessLevel`, `Wizard`) VALUES
(1, 'root@root.com', 'root', 'BaF9VWb6xBNcA', '2016-03-29', 3, 0);
