...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2016 at 07:29 PM
...
(13, '22', 'Fake Street', 'G66 1ET', 'Glasgow');
...
CREATE TABLE IF NOT EXISTS `userdetails` (
  ...
  `Firstname` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Users name',
...
INSERT INTO `userdetails` (`UserID`, `Firstname`, `Surname`, `DateOfBirth`, `Occupation`, `Address`) VALUES
(14, 'Donald', 'Webster', '1999-08-22', 14, 14);
...
INSERT INTO `userlogin` (`ID`, `EmailAddress`, `UserName`, `Password`, `DateJoined`) VALUES
(14, 'jw@hw.ac.uk', 'JW23', 'BaZMws62u.a0c', '2016-01-11');
...
ALTER TABLE `userdetails`
  ADD CONSTRAINT `userdetails_ibfk_4` FOREIGN KEY (`UserID`) REFERENCES `userlogin` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
