                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="disabled"><a href="#"> Qualifications </a></li> <!-- still to be made -->
                                <li class="disabled"><a href="#"> Starred Paths </a></li> <!-- still to be made -->
                                <li class="disabled"><a href="#"> Log out </a></li> <!-- still to be made -->
                            </ul>
                        </li>
                        <li class="active"><a href="#buildprofile"> Build Profile </a></li>
                        <li class="disabled"><a href="#choosecareer"> Choose Career </a></li>
                        <li class="disabled"><a href="#careerpathways"> Career Pathways </a></li>                       
                    </ul>
                </div>
        ...
        <div class="container-fluid">    
            <div class="row contact-wrap"> 
                <div class="col-md-6 col-md-offset-3">
                    <form id="main-contact-form" class="contact-form" name="contact-form" method="post" action="#">  <!-- still to be made -->
                                ...
                                <div id="standardgrade" class="panel-collapse collapse in">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="submit" action="#" class="btn btn-default">
                                            <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Add  <!-- still to be made -->
                                        </button>
