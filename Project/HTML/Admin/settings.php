        ...
        <div class="container-fluid">
          ...
          <div class="col-sm-3 col-md-2 sidebar" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="settings.php">Manage Admin Settings<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-wrench"></span></a></li>
            </ul>
          </div>
        </div>
      </nav>
