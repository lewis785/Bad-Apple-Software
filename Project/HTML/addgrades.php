		...
		<div id="page-center" class="main-section col-md-6 col-md-offset-3">
			<div class="row contact-wrap"> 
				<div class="col-md-6 col-md-offset-3">
					...
					<button onclick="addGrade()" id="storeGrade" class="btn btn-llg bg-headings"> Add Grade </button>  

					<button onclick="submitForm(true)" id="submitGrades" class="btn btn-llg bg-headings"> Submit Grades </button>  
